...
document.addEventListener("DOMContentLoaded", function()
{
   // == .custmonDropDwon == //
            ...
            document.addEventListener("DOMContentLoaded", function(){
   // == .custmonDropDwon == //
   document.querySelectorAll(".custmonDropDwon").forEach(function(dr){
      ...
      var customDrp=dr.querySelector(".customDrp");
      if (customDrp) {
         customDrp.classList.add("active");         
      } else {
         dr.children[0].classList.add("active");        
      }
   ...
   let basic_banner_read_btn = false;
      ...
      if (basic_banner_read_btn == false) {
         document.querySelector(".basic_banner_read_btn").text("Read Less");
         document.querySelector(".basic_banner_text").slideToggle(500);
         basic_banner_read_btn = true;
      } else {         
         document.querySelector(".basic_banner_text").slideToggle(500);
          document.querySelector(".basic_banner_read_btn").text("Read More");
   ...
   document.querySelector(".hideCustomDrp").addEventListener("click", function(){
      document.querySelector(".customDrp").slideToggle("active");
   });
   ...
   document.querySelector(".mainTable").scroll(function (e) {
      ...
      if (isScroll) {         
         ...
         document.querySelectorAll(".ListingTable th:nth-child(3), td:nth-child(3)").removeClass("active");
      }
   });
   

   // ==  responsiveTable currenciesTable == //
      document.querySelectorAll(".currenciesTable, .exchangeTable").scroll(function (e) {
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").addClass("before");
      } else {
         document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").removeClass("before");
      }
   });

   // .historical-data
   document.querySelector(".historical-data").scroll(function (e) {   
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").addClass("before");
      } else {
         document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").removeClass("before");
      }
   });

   // .financialTable
   document.addEventListener(".financialTable").on("scroll", function (e) {   
      document.querySelector(".financialTable").scroll(function (e) {  
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").addClass("before");
      } else {
   ...
   // searchPopup
   document.querySelectorAll(".header-for-mobile .searchPopup").click(function () {
...
// == == == faq scripts == == == //
document.querySelectorAll(".faqAcc .flexAccHead").forEach(function(item){
   item.addEventListener("click", function(){
 
   let AccHeadObj = item;
   let siblings=Array.from(item.parentElement.children).filter(child=>child!==item);
   siblings.forEach(siblings => siblings.querySelector(".faqDesc").classList.remove("active"));
   item.closest(".faqAcc li").querySelector(".faqDesc").classList.add("active", 2000);  
});
});
// == ===
 //== faq scripts == == == //
...
function toggleCurrencyMoreData(elem) {
   ...
   if (currentstate == alternate) {
      document.querySelectorAll(".currencyDetail .bottomListing").forEach(function(item)
      {
